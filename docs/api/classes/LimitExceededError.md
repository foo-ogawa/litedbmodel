...
| ------ | ------ | ------ | ------ | ------ |
| <a id="limit"></a> `limit` | `readonly` | `number` | - | types.ts:371 |
| <a id="actualcount"></a> `actualCount` | `readonly` | `number` | Number of records returned. For find() with findHardLimit, this is limit+1 (actual total may be higher). For relation loading, this is the exact count. | types.ts:376 |
| <a id="context"></a> `context` | `readonly` | `"find"` \| `"relation"` | - | types.ts:377 |
| <a id="modelname"></a> `modelName?` | `readonly` | `string` | - | types.ts:378 |
| <a id="relationname"></a> `relationName?` | `readonly` | `string` | - | types.ts:379 |
