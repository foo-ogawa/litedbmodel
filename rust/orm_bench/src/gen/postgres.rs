...
pub fn findAll(
    ...
    let _ = &produced_n0;
    // ── op 'n0' (executeSQL) ──
    let payload_n0 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("SELECT id, email, name FROM benchmark_users ORDER BY id ASC LIMIT 100".to_string())), ("write".to_string(), WireValue::Bool(false))] };
...
pub fn filterPaginateSort(
    ...
    let _ = &produced_n0;
    // ── op 'n0' (executeSQL) ──
    let payload_n0 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::int(published)]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("SELECT id, title, content, published, author_id, created_at FROM benchmark_posts WHERE published = ? ORDER BY created_at DESC LIMIT 20 OFFSET 10".to_string())), ("write".to_string(), WireValue::Bool(false))] };
    let wire_n0 = match execute_sql(payload_n0) {
        Ok(r) => r,
        Err(e) => return Err(op_failed("n0", "fail", e)),
    };
...
pub fn findFirst(
    ...
    let _ = &produced_n0;
    // ── op 'n0' (executeSQL) ──
    let payload_n0 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::Str(name.clone())]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("SELECT id, email, name FROM benchmark_users WHERE name LIKE ? LIMIT 1".to_string())), ("write".to_string(), WireValue::Bool(false))] };
    let wire_n0 = match execute_sql(payload_n0) {
        Ok(r) => r,
        Err(e) => return Err(op_failed("n0", "fail", e)),
    };
...
pub fn findUnique(
    ...
    let _ = &produced_n0;
    // ── op 'n0' (executeSQL) ──
    let payload_n0 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::Str(email.clone())]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("SELECT id, email, name FROM benchmark_users WHERE email = ? LIMIT 1".to_string())), ("write".to_string(), WireValue::Bool(false))] };
    let wire_n0 = match execute_sql(payload_n0) {
        Ok(r) => r,
        Err(e) => return Err(op_failed("n0", "fail", e)),
    };
...
pub fn nestedFindAll(
    ...
    let _ = &produced_n3;
    // ── op 'n0' (executeSQL) ──
    let payload_n0 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("SELECT id, email, name FROM benchmark_users LIMIT 100".to_string())), ("write".to_string(), WireValue::Bool(false))] };
    let wire_n0 = match execute_sql(payload_n0) {
        Ok(r) => r,
        Err(e) => return Err(op_failed("n0", "fail", e)),
    };
    *cell_n0.borrow_mut() = match wire_n0.as_list() {
    ...
    if produced_n1.get() {
        let payload_n2 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::List(WireList { items: cell_n1.borrow().clone() })]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("SELECT id, title, author_id FROM benchmark_posts WHERE benchmark_posts.author_id = ANY(?::@@PG_ARRAY_CAST@@) ORDER BY id ASC".to_string())), ("write".to_string(), WireValue::Bool(false))] };
...
pub fn nestedRelations(
    ...
    *cell_n0.borrow_mut() = match wire_n0.as_list() {
    ...
    if produced_n3.get() {
        let payload_n4 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::List(WireList { items: cell_n3.borrow().clone() })]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("SELECT id, body, post_id FROM benchmark_comments WHERE benchmark_comments.post_id = ANY(?::@@PG_ARRAY_CAST@@) ORDER BY id ASC".to_string())), ("write".to_string(), WireValue::Bool(false))] };
...
pub fn compositeRelations(
    ...
    let _ = &produced_n6;
    // ── op 'n0' (executeSQL) ──
    let payload_n0 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("SELECT tenant_id, user_id, name FROM benchmark_tenant_users ORDER BY user_id ASC LIMIT 100".to_string())), ("write".to_string(), WireValue::Bool(false))] };
    let wire_n0 = match execute_sql(payload_n0) {
        Ok(r) => r,
        Err(e) => return Err(op_failed("n0", "fail", e)),
    };
    *cell_n0.borrow_mut() = match wire_n0.as_list() {
    ...
    // ── op 'n2' (executeSQL, parent:n1) ──
    if produced_n1.get() {
        let payload_n2 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::List(WireList { items: cell_n1.borrow().clone() })]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("SELECT tenant_id, post_id, user_id, title FROM benchmark_tenant_posts JOIN (SELECT (_t->>0)::int AS key0, (_t->>1)::int AS key1 FROM json_array_elements(?::json) AS _t) AS _keys ON benchmark_tenant_posts.tenant_id = _keys.key0 AND benchmark_tenant_posts.user_id = _keys.key1 ORDER BY post_id ASC".to_string())), ("write".to_string(), WireValue::Bool(false))] };
        let wire_n2 = match execute_sql(payload_n2) {
            Ok(r) => r,
            Err(e) => return Err(op_failed("n2", "fail", e)),
        };
    ...
    // ── op 'n4' (executeSQL, parent:n3) ──
    if produced_n3.get() {
        let payload_n4 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::List(WireList { items: cell_n3.borrow().clone() })]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("SELECT tenant_id, comment_id, post_id, body FROM benchmark_tenant_comments JOIN (SELECT (_t->>0)::int AS key0, (_t->>1)::int AS key1 FROM json_array_elements(?::json) AS _t) AS _keys ON benchmark_tenant_comments.tenant_id = _keys.key0 AND benchmark_tenant_comments.post_id = _keys.key1 ORDER BY comment_id ASC".to_string())), ("write".to_string(), WireValue::Bool(false))] };
        let wire_n4 = match execute_sql(payload_n4) {
            Ok(r) => r,
            Err(e) => return Err(op_failed("n4", "fail", e)),
        };
...
pub fn create(
    ...
    let _ = &produced_n0;
    // ── op 'n0' (executeSQL) ──
    let payload_n0 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::Str(email.clone()), WireValue::Str(name.clone())]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("INSERT INTO benchmark_users (email, name) VALUES (?, ?)".to_string())), ("write".to_string(), WireValue::Bool(true))] };
    let wire_n0 = match execute_sql(payload_n0) {
        Ok(r) => r,
        Err(e) => return Err(op_failed("n0", "fail", e)),
    };
...
pub fn update(
    ...
    let _ = &produced_n0;
    // ── op 'n0' (executeSQL) ──
    let payload_n0 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::Str(name.clone()), WireValue::int(id)]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("UPDATE benchmark_users SET name = ? WHERE id = ?".to_string())), ("write".to_string(), WireValue::Bool(true))] };
    let wire_n0 = match execute_sql(payload_n0) {
        Ok(r) => r,
        Err(e) => return Err(op_failed("n0", "fail", e)),
    };
...
pub fn upsert(
    ...
    let _ = &produced_n0;
    // ── op 'n0' (executeSQL) ──
    let payload_n0 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::Str(email.clone()), WireValue::Str(name.clone())]; __v } })), ("returning".to_string(), WireValue::Bool(true)), ("sql".to_string(), WireValue::Str("INSERT INTO benchmark_users (email, name) VALUES (?, ?) ON CONFLICT (email) DO UPDATE SET email = excluded.email, name = excluded.name RETURNING id".to_string())), ("write".to_string(), WireValue::Bool(true))] };
    let wire_n0 = match execute_sql(payload_n0) {
        Ok(r) => r,
        Err(e) => return Err(op_failed("n0", "fail", e)),
    };
...
pub fn createMany(
    ...
    let _ = &produced_n0;
    // ── op 'n0' (executeSQL) ──
    let payload_n0 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::List(WireList { items: rows.clone().into_iter().map(|e0| WireValue::Row(WireRow { entries: vec![("email".to_string(), WireValue::Str(e0.email)), ("name".to_string(), WireValue::Str(e0.name))] })).collect() })]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("INSERT INTO benchmark_users (email, name) SELECT v.email, v.name FROM UNNEST(?::text[], ?::text[]) AS v(email, name)".to_string())), ("write".to_string(), WireValue::Bool(true))] };
    let wire_n0 = match execute_sql(payload_n0) {
        Ok(r) => r,
        Err(e) => return Err(op_failed("n0", "fail", e)),
    };
...
pub fn upsertMany(
    ...
    let _ = &produced_n0;
    // ── op 'n0' (executeSQL) ──
    let payload_n0 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::List(WireList { items: rows.clone().into_iter().map(|e0| WireValue::Row(WireRow { entries: vec![("email".to_string(), WireValue::Str(e0.email)), ("name".to_string(), WireValue::Str(e0.name))] })).collect() }), WireValue::List(WireList { items: rows.clone().into_iter().map(|e0| WireValue::Row(WireRow { entries: vec![("email".to_string(), WireValue::Str(e0.email)), ("name".to_string(), WireValue::Str(e0.name))] })).collect() })]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("INSERT INTO benchmark_users (email, name) SELECT v.email, v.name FROM UNNEST(?::text[], ?::text[]) AS v(email, name) ON CONFLICT (email) DO UPDATE SET email = EXCLUDED.email, name = EXCLUDED.name".to_string())), ("write".to_string(), WireValue::Bool(true))] };
    let wire_n0 = match execute_sql(payload_n0) {
        Ok(r) => r,
        Err(e) => return Err(op_failed("n0", "fail", e)),
    };
...
pub fn updateMany(
    ...
    let _ = &produced_n0;
    // ── op 'n0' (executeSQL) ──
    let payload_n0 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::List(WireList { items: rows.clone().into_iter().map(|e0| WireValue::Row(WireRow { entries: vec![("id".to_string(), WireValue::int(e0.id)), ("name".to_string(), WireValue::Str(e0.name))] })).collect() })]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("UPDATE benchmark_users AS t SET name = v.name FROM UNNEST(?::int[], ?::text[]) AS v(id, name) WHERE t.id = v.id".to_string())), ("write".to_string(), WireValue::Bool(true))] };
    let wire_n0 = match execute_sql(payload_n0) {
        Ok(r) => r,
        Err(e) => return Err(op_failed("n0", "fail", e)),
    };
    ...
    *cell_n0.borrow_mut() = match wire_n0.as_list() {
    ...
    if produced_n0.get() {
        ...
        for oel_n1 in over_n1.iter() {
            let ep_n1 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::int(oel_n1.id), WireValue::Str(title.clone())]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("INSERT INTO benchmark_posts (author_id, title) VALUES (?, ?)".to_string())), ("write".to_string(), WireValue::Bool(true))] };
...
pub fn nestedUpdate(
    ...
    let _ = &produced_n1;
    // ── op 'n0' (executeSQL) ──
    let payload_n0 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::Str(name.clone()), WireValue::int(id)]; __v } })), ("returning".to_string(), WireValue::Bool(true)), ("sql".to_string(), WireValue::Str("UPDATE benchmark_users SET name = ? WHERE id = ? RETURNING id".to_string())), ("write".to_string(), WireValue::Bool(true))] };
    let wire_n0 = match execute_sql(payload_n0) {
        Ok(r) => r,
        Err(e) => return Err(op_failed("n0", "fail", e)),
    };
    *cell_n0.borrow_mut() = match wire_n0.as_list() {
    ...
    if produced_n0.get() {
        ...
        let mut built_n1: Vec<Vec<WriteSummary>> = Vec::with_capacity(over_n1.len());
        for oel_n1 in over_n1.iter() {
            let ep_n1 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::Str(title.clone()), WireValue::int(oel_n1.id)]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("UPDATE benchmark_posts SET title = ? WHERE author_id = ?".to_string())), ("write".to_string(), WireValue::Bool(true))] };
            let er_n1 = match execute_sql(ep_n1) {
                Ok(r) => r,
                Err(e) => return Err(op_failed("n1", "fail", e)),
            };
...
pub fn delete(
    ...
    *cell_n0.borrow_mut() = match wire_n0.as_list() {
    ...
    if produced_n0.get() {
        ...
        let mut built_n1: Vec<Vec<WriteSummary>> = Vec::with_capacity(over_n1.len());
        for oel_n1 in over_n1.iter() {
            let ep_n1 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(true)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::int(oel_n1.id)]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("DELETE FROM benchmark_users WHERE id = ?".to_string())), ("write".to_string(), WireValue::Bool(true))] };
            let er_n1 = match execute_sql(ep_n1) {
                Ok(r) => r,
                Err(e) => return Err(op_failed("n1", "fail", e)),
            };
