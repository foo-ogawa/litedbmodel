...
pub fn nestedFindAll() -> Result<Vec<UserWithPosts>, BehaviorError> {
    ...
    *cell_n0.borrow_mut() = match wire_n0.as_list() {
    ...
    if produced_n1.get() {
        let payload_n2 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(false)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::List(WireList { items: cell_n1.borrow().clone() })]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("SELECT id, title, author_id FROM benchmark_posts WHERE benchmark_posts.author_id = ANY(?::@@PG_ARRAY_CAST@@) ORDER BY id ASC".to_string())), ("write".to_string(), WireValue::Bool(false))] };
...
pub fn nestedRelations() -> Result<Vec<UserWithPostsAndComments>, BehaviorError> {
    ...
    *cell_n0.borrow_mut() = match wire_n0.as_list() {
    ...
    if produced_n3.get() {
        let payload_n4 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(false)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::List(WireList { items: cell_n3.borrow().clone() })]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("SELECT id, body, post_id FROM benchmark_comments WHERE benchmark_comments.post_id = ANY(?::@@PG_ARRAY_CAST@@) ORDER BY id ASC".to_string())), ("write".to_string(), WireValue::Bool(false))] };
...
pub fn compositeRelations() -> Result<Vec<TenantUserWithPosts>, BehaviorError> {
    ...
    *cell_n0.borrow_mut() = match wire_n0.as_list() {
    ...
    // ── op 'n4' (executeSQL, parent:n3) ──
    if produced_n3.get() {
        let payload_n4 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(false)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::List(WireList { items: cell_n3.borrow().clone() })]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("SELECT tenant_id, comment_id, post_id, body FROM benchmark_tenant_comments JOIN (SELECT (_t->>0)::int AS key0, (_t->>1)::int AS key1 FROM json_array_elements(?::json) AS _t) AS _keys ON benchmark_tenant_comments.tenant_id = _keys.key0 AND benchmark_tenant_comments.post_id = _keys.key1 ORDER BY comment_id ASC".to_string())), ("write".to_string(), WireValue::Bool(false))] };
        let wire_n4 = match execute_sql(payload_n4) {
            Ok(r) => r,
            Err(e) => return Err(op_failed("n4", "fail", e)),
        };
...
pub fn createMany(rows: Vec<NewUser>) -> Result<Vec<WriteSummary>, BehaviorError> {
    ...
    for oel_n0 in over_n0.iter() {
        cell_n0
            .borrow_mut()
            .push(WireValue::Str(oel_n0.email.clone()));
    }
    produced_n0.set(true);
    ...
    for oel_n1 in over_n1.iter() {
        cell_n1
            .borrow_mut()
            .push(WireValue::Str(oel_n1.name.clone()));
    }
    produced_n1.set(true);
    // ── op 'n2' (executeSQL, parent:n0) ──
    if produced_n0.get() {
        let payload_n2 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(false)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::List(WireList { items: cell_n0.borrow().clone() }), WireValue::List(WireList { items: cell_n1.borrow().clone() })]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("INSERT INTO benchmark_users (email, name) SELECT v.email, v.name FROM UNNEST(?::text[], ?::text[]) AS v(email, name)".to_string())), ("write".to_string(), WireValue::Bool(true))] };
        let wire_n2 = match execute_sql(payload_n2) {
            Ok(r) => r,
            Err(e) => return Err(op_failed("n2", "fail", e)),
        };
    ...
    let __out = cell_n2.borrow().clone();
    Ok(__out)
}
...
pub fn updateMany(rows: Vec<UserPatch>) -> Result<Vec<WriteSummary>, BehaviorError> {
    ...
    // ── op 'n2' (executeSQL, parent:n0) ──
    if produced_n0.get() {
        let payload_n2 = WireRow { entries: vec![("bigint".to_string(), WireValue::Bool(false)), ("params".to_string(), WireValue::List(WireList { items: { let __v: Vec<WireValue> = vec![WireValue::List(WireList { items: cell_n0.borrow().clone() }), WireValue::List(WireList { items: cell_n1.borrow().clone() })]; __v } })), ("returning".to_string(), WireValue::Bool(false)), ("sql".to_string(), WireValue::Str("UPDATE benchmark_users AS t SET name = v.name FROM UNNEST(?::int[], ?::text[]) AS v(id, name) WHERE t.id = v.id".to_string())), ("write".to_string(), WireValue::Bool(true))] };
        let wire_n2 = match execute_sql(payload_n2) {
            Ok(r) => r,
            Err(e) => return Err(op_failed("n2", "fail", e)),
        };
...
pub fn nestedCreate(
    ...
    let payload_n0 = WireRow {
        entries: vec![
            ...
            ("returning".to_string(), WireValue::Bool(true)),
            (
                "sql".to_string(),
                WireValue::Str(
    ...
    let payload_n0 = WireRow {
        entries: vec![
            ...
            (
                "sql".to_string(),
                WireValue::Str(
                    "UPDATE benchmark_users SET name = ? WHERE id = ? RETURNING id".to_string(),
                ),
            ),
            ("write".to_string(), WireValue::Bool(true)),
        ],
