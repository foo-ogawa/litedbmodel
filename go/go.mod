module github.com/foo-ogawa/litedbmodel/go/v3
...
// dependency. Pinned to the PUBLISHED VCS tag `go/v0.11.7` (NO local `replace` onto a sibling
...
require github.com/foo-ogawa/behavior-contracts/go v0.11.17
