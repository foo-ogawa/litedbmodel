...
export function userRows(it, stable) {
    return Array.from({ length: 10 }, (_, i) => ({
        email: stable ? `many${i}@bench.com` : `many${it}_${i}@bench.com`,
        name: `Many ${i}`,
    }));
}
export function updateManyRows() {
...
export function inputFor(op, it) {
    switch (op) {
        case 'findAll':
        case 'nestedFindAll':
 ...
 */
export const EXPECTED_STATEMENTS = {
    findAll: 1,
...
export const TX_OPS = new Set(['nestedCreate', 'nestedUpsert', 'nestedUpdate', 'delete']);
